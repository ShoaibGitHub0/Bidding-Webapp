...
function AuctionDetail() {
    ...
    // Fetch auction details on initial load or when the id changes
    ...
    useEffect(() => {
        fetchAuctionDetail();
    }, [id, AI2]); // Run fetch when ID or AI2 changes
    ...
    async function Comments(id, comment) {
        ...
        try {
            ...
            console.log(response);
            if (response.status === 201) {
                // After posting a comment, re-fetch auction details to update the comments
                fetchAuctionDetail();
    ...
    // If auctionItem is not loaded yet
    if (!auctionItem) {
    ...
    return (
        <div className="container mt-4">
            <h1 className="text-center text-primary mb-4">Auction Details</h1>
            <div className="card shadow-sm">
                <div className="card-body">
                    ...
                    <img src={auctionItem.image} alt={auctionItem.title} className="img-fluid rounded mb-3" />
